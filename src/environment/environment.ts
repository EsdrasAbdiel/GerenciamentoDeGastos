export const environment = {
	...
	BASE_URL: {
		...
		cadastrarResumoFinanceiroImportacaoExtrato: 'http://localhost:8080/api/importacaoExtrato/cadastrarResumoFinanceiro/importacaoExtrato',
		buscarExtratoPeloTenantId: 'http://localhost:8080/api/importacaoExtrato',
