...
export const routes: Routes = [
	...
	{
		path: 'card-anos', component: MenuCardsComponent, canActivate: [authGuard]
	},
	{
		path: ':ano/:mes/detalhes', component: DetalhesComponent, canActivate: [authGuard]
	},
	{
		path: ':ano/:mes/:id', component: DetalhesComponent, canActivate: [authGuard]
	},
	{
		path: 'exportacao-pdf', component: ExportacaoPdfComponent, canActivate: [authGuard]
	},
	{
		path: 'detalhes-exportacao-pdf', component: DetalhesExportacaoPdfComponent, canActivate: [authGuard]
	},
	{
